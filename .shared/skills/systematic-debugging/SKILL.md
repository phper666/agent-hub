...
description: Use when encountering any bug, test failure, or unexpected behavior. Execute before proposing a fix. Trigger on: "debug", "bug fix", "root cause", "test failure".
---

# Systematic Debugging

> Source: superpowers (159k+ stars) + Rules 2.1 bug-fix (92★)
> Shared skill — always loaded for Frontend/Backend/QA

## When to Load This Skill

| Role | Task Domain | Load? |
|------|------------|:-----:|
| QA | Bug reproduction, root cause, fix verification | ✅ Always — load full (incl. Bug Fix Closure) |
| Backend | Bug reproduction, root cause | ✅ Always — load full |
| Frontend | Bug reproduction, root cause | ✅ Always — load full |
| All other roles | Debugging | ⚠️ Load on demand |
...
> This section: **QA only** — loaded as part of Core. Other roles skip.
