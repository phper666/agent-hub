...
description: 在构建前端组件时使用，确保组件质量和一致性。Trigger on: "component design", "UI component", "React component", "frontend engineering".
---
...
|------|------------|:-----:|
| Frontend | UI implementation, components, styling | ✅ Always — load full |
| Designer | Component spec, design system | ✅ Always — load full |
