---
name: pr-review
description: 在进行 PR 审查时使用，自动生成 PR 描述、审查代码、提供建议。Trigger on: "PR review", "pull request", "/describe", "/review".
---
...
|------|------------|:-----:|
| Backend | PR review, PR description, changelog | ✅ Always — load full |
| Frontend | PR review, PR description, changelog | ✅ Always — load full |
| QA | PR review pipeline (complement to crg) | ⚠️ Load on demand |
