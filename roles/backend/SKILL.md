...
4. `.shared/skills/test-driven-development/` — TDD（与前端+QA 共享）
5. `.shared/skills/subagent-driven-development/` — 子 Agent 开发（与前端共享）
6. `.shared/skills/systematic-debugging/` — 系统化调试（与前端+QA 共享）
7. 本文件（角色指令）
